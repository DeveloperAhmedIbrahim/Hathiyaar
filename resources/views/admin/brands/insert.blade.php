...
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Brand /</span> New
</h4>

<div class="card">
    <h5 class="card-header d-flex justify-content-start">
        <a href="{{ route('admin.brand.list') }}" class="btn btn-info waves-effect waves-light btn-sm"><i class="fa-solid fa-backward"></i>&nbsp;<span>Return Categories</span></a>
    </h5>
    <div class="card-body row">
        <form onsubmit="submission(event, '{{ route('admin.brand.insert') }}')" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
