        ...
        <div class="container">
            <div class="breadcrumb-container">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('auth.register') }}">Register</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div id="account-register" class="container">
            <div class="row">
                ...
                <div id="content" class="col">
                    <p>If you already have an account with us, please login at the <a href="{{ route('auth.login') }}">login page</a>.</p>
