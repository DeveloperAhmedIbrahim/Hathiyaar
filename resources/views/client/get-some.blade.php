...
<div class="breadcrumb-main">
    <div class="container">
        <div class="breadcrumb-container">
            <h1 class="page-title">Where Can I Get Some?</h1>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fas
                                fa-home"></i></a></li>
                <li class="breadcrumb-item"><a href="{{ route('blog') }}">Blogs</a></li>
                <li class="breadcrumb-item"><a href="{{ route('getSome') }}">Where Can I Get Some?</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div id="content" class="col-sm-9  single-blog">
                <div class="article-blog">
                    <div class="blog-image">
                        <img src="{{ asset('assets/client/images/blogs/2.png') }}" alt="Many Publishing Packages" title="Many Publishing Packages" class="img-responsive mw-100">
                    </div>
                    <div class="blog-description">
                        ...
                        <div class="blog_title">WHERE CAN I GET SOME?</div>
                        <div class="blog-desc">
