    ...
    <div class="container">
        <div class="breadcrumb-container">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('standardLorem') }}">The Standard Lorem</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div id="content" class="col-sm-9  single-blog">
                <div class="article-blog">
                    <div class="blog-image">
                        <img src="{{ asset('assets/client/images/blogs/5.png') }}" alt="Many Publishing Packages" title="Many Publishing Packages" class="img-responsive mw-100">
                    </div>
